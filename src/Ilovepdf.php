...
use JJArroyo\LaravelIlovepdf\Exceptions\DownloadException;
use JJArroyo\LaravelIlovepdf\Exceptions\ProcessException;
use JJArroyo\LaravelIlovepdf\Exceptions\TaskException;
use JJArroyo\LaravelIlovepdf\Exceptions\UploadException;
use JJArroyo\LaravelIlovepdf\Exceptions\StartException;
use JJArroyo\LaravelIlovepdf\Exceptions\AuthException;
use JJArroyo\LaravelIlovepdf\IlovepdfTool;
use JJArroyo\LaravelIlovepdf\Request\Body;
...
//        }
    ...
    {
        $classname = '\\JJArroyo\\LaravelIlovepdf\\' . ucwords(strtolower($tool)) . 'Task';
